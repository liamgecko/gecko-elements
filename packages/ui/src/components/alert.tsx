  ...
  return (
    <div
      ...
      className={cn(
        ...
        "group-data-[variant=destructive]/alert:[&_[data-slot=button]:hover]:bg-destructive/10 group-data-[variant=destructive]/alert:[&_[data-slot=button]:hover]:text-destructive group-data-[variant=destructive]/alert:[&_[data-slot=button]:focus-visible]:border-destructive/40 group-data-[variant=destructive]/alert:[&_[data-slot=button]:focus-visible]:bg-destructive-muted group-data-[variant=destructive]/alert:[&_[data-slot=button]:focus-visible]:text-destructive group-data-[variant=destructive]/alert:[&_[data-slot=button]:focus-visible]:ring-destructive/20 dark:group-data-[variant=destructive]/alert:[&_[data-slot=button]:hover]:bg-destructive/20 dark:group-data-[variant=destructive]/alert:[&_[data-slot=button]:focus-visible]:ring-destructive/40",
        "group-data-[variant=info]/alert:[&_[data-slot=button]:hover]:bg-info/10 group-data-[variant=info]/alert:[&_[data-slot=button]:hover]:text-info group-data-[variant=info]/alert:[&_[data-slot=button]:focus-visible]:border-info/40 group-data-[variant=info]/alert:[&_[data-slot=button]:focus-visible]:bg-info-muted group-data-[variant=info]/alert:[&_[data-slot=button]:focus-visible]:text-info group-data-[variant=info]/alert:[&_[data-slot=button]:focus-visible]:ring-info/20 dark:group-data-[variant=info]/alert:[&_[data-slot=button]:hover]:bg-info/20 dark:group-data-[variant=info]/alert:[&_[data-slot=button]:focus-visible]:ring-info/40",
        "group-data-[variant=success]/alert:[&_[data-slot=button]:hover]:bg-success/10 group-data-[variant=success]/alert:[&_[data-slot=button]:hover]:text-success group-data-[variant=success]/alert:[&_[data-slot=button]:focus-visible]:border-success/40 group-data-[variant=success]/alert:[&_[data-slot=button]:focus-visible]:bg-success-muted group-data-[variant=success]/alert:[&_[data-slot=button]:focus-visible]:text-success group-data-[variant=success]/alert:[&_[data-slot=button]:focus-visible]:ring-success/20 dark:group-data-[variant=success]/alert:[&_[data-slot=button]:hover]:bg-success/20 dark:group-data-[variant=success]/alert:[&_[data-slot=button]:focus-visible]:ring-success/40",
        "group-data-[variant=warning]/alert:[&_[data-slot=button]:hover]:bg-warning/10 group-data-[variant=warning]/alert:[&_[data-slot=button]:hover]:text-warning group-data-[variant=warning]/alert:[&_[data-slot=button]:focus-visible]:border-warning/40 group-data-[variant=warning]/alert:[&_[data-slot=button]:focus-visible]:bg-warning-muted group-data-[variant=warning]/alert:[&_[data-slot=button]:focus-visible]:text-warning group-data-[variant=warning]/alert:[&_[data-slot=button]:focus-visible]:ring-warning/20 dark:group-data-[variant=warning]/alert:[&_[data-slot=button]:hover]:bg-warning/20 dark:group-data-[variant=warning]/alert:[&_[data-slot=button]:focus-visible]:ring-warning/40",
        className,
      )}
      {...props}
    />
