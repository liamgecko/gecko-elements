...
function SelectTrigger({
  ...
  return (
    <SelectPrimitive.Trigger
      ...
      data-size={size}
      className={cn(
        "border-input data-placeholder:text-muted-foreground aria-invalid:data-placeholder:text-destructive focus-visible:border-ring focus-visible:ring-ring/50 aria-invalid:focus-visible:ring-input-destructive/20 dark:aria-invalid:focus-visible:ring-input-destructive/40 aria-invalid:border-input-destructive gap-1.5 rounded-sm border bg-transparent py-2 pe-2 ps-2.5 text-sm transition-[color] focus-visible:ring-3 aria-invalid:focus-visible:ring-3 data-[size=sm]:h-7 data-[size=sm]:text-xs data-[size=default]:h-8 data-[size=lg]:h-9 data-[size=lg]:text-md *:data-[slot=select-value]:gap-1.5 [&_svg:not([class*='size-'])]:size-4 flex w-fit items-center justify-between whitespace-nowrap outline-none disabled:pointer-events-none disabled:cursor-not-allowed disabled:opacity-75 *:data-[slot=select-value]:line-clamp-1 *:data-[slot=select-value]:flex *:data-[slot=select-value]:items-center [&_svg]:pointer-events-none [&_svg]:shrink-0",
        className
      )}
      {...props}
    >
