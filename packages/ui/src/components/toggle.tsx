  ...
  ].join(" "),
  {
    variants: {
      variant: {
        ...
        "ghost-light":
          "bg-transparent hover:bg-light-surface-hover hover:text-foreground aria-pressed:bg-light-surface-hover aria-pressed:text-foreground",
        "ghost-dark":
          "bg-transparent text-dark-surface-foreground hover:bg-dark-surface-hover hover:text-dark-surface-foreground aria-pressed:bg-dark-surface-hover aria-pressed:text-dark-surface-foreground",
        outline:
