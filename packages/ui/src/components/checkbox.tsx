...
function Checkbox({
  ...
  return (
    <div
      ...
      className={cn(
        "group/checkbox flex gap-2 data-[disabled=true]:pointer-events-none data-[disabled=true]:cursor-not-allowed",
