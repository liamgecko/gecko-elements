...
function FieldLabel({
  ...
  return (
    <Label
      ...
      className={cn(
        "has-data-checked:bg-primary/5 has-data-checked:border-primary/30 dark:has-data-checked:border-primary/20 dark:has-data-checked:bg-primary/10 gap-1 has-[>[data-slot=field]]:rounded-lg has-[>[data-slot=field]]:border *:data-[slot=field]:p-2.5 group/field-label peer/field-label flex w-fit leading-snug",
...
function FieldTitle({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      data-slot="field-label"
      className={cn(
        "gap-1 text-sm font-medium flex w-fit items-center leading-snug",
        className,
      )}
      {...props}
    />
...
function FieldDescription({ className, ...props }: React.ComponentProps<"p">) {
  return (
    <p
      ...
      className={cn(
        "text-muted-foreground text-left text-2xs [[data-variant=legend]+&]:-mt-1.5 leading-normal font-normal group-has-data-horizontal/field:text-balance",
...
function FieldError({
  ...
  return (
    <div
      ...
      className={cn(
        "bg-destructive-muted text-destructive-muted-foreground text-2xs font-normal px-2 py-1.5 rounded-xs flex items-center gap-1.5 [&_svg]:shrink-0 [&_svg]:size-3",
        className,
      )}
      {...props}
    >
