...
const navItems: NavItem[] = [
  ...
  { to: "/components/charts", label: "Charts" },
  { to: "/components/chat-bubble", label: "Chat bubble" },
  { to: "/components/chat-head", label: "Chat head" },
  ...
  { to: "/components/file-tree", label: "File tree" },
