...
function CardContent({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn("p-4 group-data-[size=sm]/card:p-4", className)}
      {...props}
    />
  )
}
...
function CardFooter({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn("rounded-b-sm border-t p-4 group-data-[size=sm]/card:p-4 flex items-center justify-end gap-2", className)}
      {...props}
    />
  )
}
