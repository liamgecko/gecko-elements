      ...
      <div className="min-w-0 flex-1 space-y-10 border-r-0 pr-0 lg:border-r lg:border-border lg:pr-8">
        <PageSection id="overview" label="Overview">
          ...
          <p className="text-sm text-muted-foreground">
            Our design system leverages a purposeful set of color styles. When it comes to color, contrast is critical for ensuring text is legible. We've added WCAG 2.2 contrast ratios to our color system so you can make sure you're designing with accessibility in mind.
          </p>
        </PageSection>
        ...
        <PageSection id="primary-colors" label="Primary colors">
          ...
          <p className="mb-8 text-sm text-muted-foreground">
          Our primary colors are a palette consists of grays tones, chosen for its neutrality, professionalism and workability with various color schemes set by the customer. They are used extensively throughout our UI to draw attention to key elements like buttons and active navigation items.
          </p>
        ...
        <PageSection id="secondary-colors" label="Secondary colors">
          ...
          <p className="mb-8 text-sm text-muted-foreground">
            Secondary colors add vibrancy to our design, intended for highlighting secondary information and guiding the user's attention to less critical elements. These hues are chosen to complement our primary palette while providing a visual distinction.
          </p>
          ...
          <p className="mb-4 text-sm text-muted-foreground">
            Accessibility is at the forefront of our color choices. We ensure that all colors in our palette meet the WCAG guidelines for contrast, making sure that our content is legible and accessible to all users, including those with visual impairments.
          </p>
          <p className="text-sm text-muted-foreground">
