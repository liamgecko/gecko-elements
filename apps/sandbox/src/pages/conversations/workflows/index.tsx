...
export default function ConversationsWorkflowsPage() {
  ...
  return (
    <div className="flex flex-col">
      <Header
        ...
        title="Workflows"
        primaryAction={{ label: "Create new workflow" }}
        secondaryActions={[{ label: "Save workflows" }]}
        favouriteAction={{
          pressed: isFavourited(pathname),
          onPressedChange: (next) => {
            setFavourite({ path: pathname, label: "Workflows" }, next)
          },
        }}
      />
      <Container>
