    ...
    <div className="space-y-12">
      ...
      <PageSection id="usage" label="Usage">
        <PageSectionHeader
          ...
          description={
            <>
              Use standalone Tabs when content within a page needs sectioning
              and only one section should be visible at a time.
              <br />
              <br />
              For sub-pages within a section that need sub-navigation, put tabs
              on the page-level{" "}
              <DocsPageLink to="/structure/header">
                Page Header
              </DocsPageLink>{" "}
              instead. Avoid using tabs for long lists of options or when every
              section should stay visible. To show counts or labels on a tab,
              add a <DocsPageLink to="/components/badge">Badge</DocsPageLink>{" "}
              inside the trigger.
            </>
          }
        />
