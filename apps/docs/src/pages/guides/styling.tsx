...
export function GuidesStylingPage() {
  return (
    <div className="space-y-12">
      ...
      <PageSection id="the-contract" label="The contract">
        <PageSectionHeader
          title="The contract"
          description={
            <>
              Every component owns its own chrome: padding, radius, colour,
              font size, and shadows. Use <Code>variant</Code> and{" "}
              <Code>size</Code> to choose the look. Use{" "}
              <Code>className</Code> only for layout around the component —
              margin, width, grid placement — never to override its internals.
            </>
          }
        />
        ...
        <PageSubsectionHeader
          ...
          description={
            <>
              The Core pages document the design tokens that components
              consume. Use them in your own layouts, but do not apply them to
              override a component's built-in styling.
            </>
          }
        />
        <ul className="mb-6 space-y-2 text-sm text-muted-foreground">
          ...
          <li>
            <DocsPageLink to="/core/shadows">Shadows</DocsPageLink> — elevation
            and box-shadow patterns.
          </li>
        </ul>
        ...
        <DocsDoDont
          doItems={[
            ...
            <>
              Use <Code>variant</Code> and <Code>size</Code> props to change
              a component's look.
            </>,
            <>
      ...
      <PageSection id="layout-wrappers" label="Layout wrappers">
        <PageSectionHeader
          title="Layout wrappers"
          description={
            <>
              <DocsPageLink to="/structure/header">Page Header</DocsPageLink> and{" "}
              <DocsPageLink to="/structure/container">Page Container</DocsPageLink>{" "}
