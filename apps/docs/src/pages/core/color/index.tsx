  ...
  return (
    <div>
      <HeaderSection
        ...
        description={
          <>
            Our colour system is designed to provide clarity, consistency, and
            accessibility across the product. Colours are used to communicate
            hierarchy, meaning, and interaction, while meeting WCAG 2.2 contrast
            standards to ensure content is legible for all users.
          </>
        }
      />
      ...
      <MainSection
        ...
        description={
          <>
            Base colours define the foundation of the system, including neutral
            surfaces and core brand colours. These are used across the majority
      ...
      <MainSection
        ...
        description={
          <>
            Primary colours define the core UI surfaces and text hierarchy.
            Neutral tones are used extensively to create structure, support
            readability, and provide a consistent foundation for all components.
          </>
        }
      >
        <ChildSection id="color-gray" title={<>Gray</>}>
          <ComponentExample>
            <ColorRow>
              <ColorChip
        ...
        <ChildSection title={<>Guidelines:</>}>
          <ul className="list-disc list-inside text-sm text-muted-foreground pl-4 mb-8">
            <li className="text-sm">
              Use for layout, surfaces, and text hierarchy
            </li>
            <li className="text-sm">
              Apply to backgrounds, borders, and neutral UI elements
            </li>
            <li className="text-sm">
              Use different shades to create depth and structure
            </li>
            <li className="text-sm">
              Avoid relying on gray alone to communicate meaning
            </li>
          </ul>
        </ChildSection>
      </MainSection>
      ...
      <MainSection
        ...
        description={
          <>
            Secondary colours are used to communicate meaning and draw attention
            to key elements. Each colour has a defined semantic purpose. Always
            use colours consistently according to their meaning.
          </>
        }
      >
        <ChildSection id="color-red" title={<>Red</>}>
          <ComponentExample>
        ...
        <ChildSection title={<>Guidelines:</>}>
          <ul className="list-disc list-inside text-sm text-muted-foreground pl-4 mb-8">
            ...
            <li className="text-sm">
              Apply to validation messages and critical alerts
            </li>
            <li className="text-sm">
              Use for destructive buttons (e.g. delete)
            </li>
            <li className="text-sm">
              Avoid using red for non-critical UI elements
            </li>
          </ul>
        </ChildSection>
        <ChildSection id="color-orange" title={<>Orange</>}>
          <ComponentExample>
            <ColorRow>
              <ColorChip
        ...
        <ChildSection title={<>Guidelines:</>}>
          <ul className="list-disc list-inside text-sm text-muted-foreground pl-4 mb-8">
            <li className="text-sm">
              Use for warning states and important alerts
            </li>
            <li className="text-sm">
              Apply to situations requiring user attention
            </li>
            <li className="text-sm">
              Use for non-critical but important feedback
            </li>
            <li className="text-sm">
              Avoid using orange for success or neutral content
            </li>
          </ul>
        </ChildSection>
        <ChildSection id="color-yellow" title={<>Yellow</>}>
          <ComponentExample>
            <ColorRow>
              <ColorChip
        ...
        <ChildSection title={<>Guidelines:</>}>
          <ul className="list-disc list-inside text-sm text-muted-foreground pl-4 mb-8">
            <li className="text-sm">
              Use for cautionary messaging and highlights
            </li>
            <li className="text-sm">
              Apply to low-severity warnings and notices
            </li>
            <li className="text-sm">
              Use to draw attention to important information
            </li>
            <li className="text-sm">
              Ensure sufficient contrast when used with text
            </li>
          </ul>
        </ChildSection>
        <ChildSection id="color-emerald" title={<>Green</>}>
          <ComponentExample>
            <ColorRow className="dark:hidden">
              <ColorChip
        ...
        <ChildSection title={<>Guidelines:</>}>
          <ul className="list-disc list-inside text-sm text-muted-foreground pl-4 mb-8">
            <li className="text-sm">
              Use for success states and confirmations
            </li>
            <li className="text-sm">
              Apply to completed actions and positive feedback
            </li>
            <li className="text-sm">
              Use for status indicators where appropriate
            </li>
            <li className="text-sm">
              Avoid using for primary actions unless tied to success
            </li>
          </ul>
        </ChildSection>
        <ChildSection id="color-blue" title={<>Blue</>}>
          <ComponentExample>
            <ColorRow>
              <ColorChip
        ...
        <ChildSection title={<>Guidelines:</>}>
          <ul className="list-disc list-inside text-sm text-muted-foreground pl-4 mb-8">
            <li className="text-sm">
              Use for informational content and messaging
            </li>
            <li className="text-sm">Apply to links and navigation elements</li>
            <li className="text-sm">
              Use for primary actions where appropriate
            </li>
            <li className="text-sm">
              Maintain consistent usage across interactive elements
            </li>
          </ul>
        </ChildSection>
        <ChildSection id="color-violet" title={<>Violet</>}>
          <ComponentExample>
            <ColorRow>
              <ColorChip
        ...
        <ChildSection title={<>Guidelines:</>}>
          <ul className="list-disc list-inside text-sm text-muted-foreground pl-4 mb-8">
            ...
            <li className="text-sm">
              Apply to highlight key elements or sections
            </li>
      ...
      <MainSection
        ...
        description={
          <>
            Accessibility is a core requirement of our colour system. All
            colours meet WCAG 2.2 contrast standards to ensure readability
            across text and UI elements. Each colour is displayed with its
            contrast ratio to support informed usage.
          </>
        }
      >
        <p className="text-sm text-muted-foreground">
          All colors are shown with accompanying text color, with their
          accessibility score stated.
        </p>
      </MainSection>
    </div>
  );
