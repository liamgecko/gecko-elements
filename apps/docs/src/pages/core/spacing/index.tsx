  ...
  return (
    <div>
      <HeaderSection
        ...
        description={
          <>
            Spacing defines layout, structure, and visual rhythm across the
            interface. Our system uses a consistent, token-based scale to ensure
            alignment, predictability, and balance across components.
          </>
        }
      />
      ...
      <MainSection
        ...
        description={
          <>
            Spacing should be applied consistently using predefined tokens.
            These guidelines help maintain alignment, create clear structure,
            and ensure predictable layouts across the interface.
          </>
        }
      >
        <ChildSection title={<>Guidelines:</>}>
          <ul className="list-disc list-inside text-sm text-muted-foreground pl-4 mb-4">
            <li className="text-sm">
              Use spacing tokens consistently across layouts and components
            </li>
            <li className="text-sm">
              Avoid arbitrary or one-off spacing values
            </li>
            <li className="text-sm">
              Use smaller spacing for dense UI and larger spacing for layout
              separation
            </li>
            <li className="text-sm">
            ...
            <li className="text-sm">
              Use spacing to create clear hierarchy and grouping
            </li>
          </ul>
        </ChildSection>
      </MainSection>
      ...
      <MainSection
        ...
        description={
          <>
            Spacing is based on tokens (e.g. <Code>p-4</Code>,{" "}
            <Code>gap-6</Code>) mapped to a consistent rem/px scale. This
            ensures predictable layouts and avoids one-off spacing values.
          </>
        }
      >
        <ComponentExample>
      ...
      <MainSection
        ...
        description={
          <>
            Spacing patterns define how spacing utilities are applied across
            layouts and components. Using consistent patterns ensures
            predictable structure, improves readability, and reduces the need
            for one-off spacing decisions.
          </>
        }
      >
        <ComponentExample>
            ...
            <Table>
              ...
              <TableBody>
                ...
                <TableRow>
                  ...
                  <TableCell>
                    Spacing between items in flex and grid layouts
                  </TableCell>
                </TableRow>
                <TableRow>
                  <TableCell>Space between</TableCell>
                  <TableCell>
                    <Code>space-x-*, space-y-*</Code>
                  </TableCell>
                  <TableCell>
                    Consistent spacing between sibling elements
                  </TableCell>
                </TableRow>
                <TableRow>
                  <TableCell>Inset</TableCell>
                  <TableCell>
                    <Code>top-*, right-*, bottom-*, left-*, inset-*</Code>
                  </TableCell>
                  <TableCell>
                ...
                <TableRow>
                  ...
                  <TableCell>
                    <Code>-m-*, -mt-*, -space-x-*</Code>
                  </TableCell>
                  <TableCell>
                    Used sparingly for overlapping or offset layouts
                  </TableCell>
                </TableRow>
              </TableBody>
            </Table>
